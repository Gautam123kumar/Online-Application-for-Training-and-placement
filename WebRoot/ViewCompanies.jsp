      ...
      <table bgcolor="#ff9900" border="0" cellpadding="0" cellspacing="0" width="778">
        ...
        <tr>
          ...
          <td width="751" height="391" align="center" valign="top" background="index_files/BG.gif" bgcolor="#ff9900" style="width: 190px;"><div align="center">
            ...
            <tr>
              <td height="232" valign="top"><form name="f" method="post" action="DeleteCompanyAction.jsp">
               <%
	     ...
	     try{
             ...
             cCoreHash = aCompanydao.listCompanies();
             session.setAttribute("companies",cCoreHash);
          	...
          	{%>
                <table width="86%" border="0" align="center">
                  <tr>
                    ...
                    <td width="201" bgcolor="#FF9600"><div align="center"><strong>Email</strong></div></td>
                    <td width="202" bgcolor="#FF9600"><div align="center"><strong>Contact</strong></div></td>
                  </tr>
                  <%
                    ...
                    %>
                  <tr>
                    <td bgcolor="#FFB76F"><input type="checkbox" name="ch" id="checkbox2" value="<%=(aCompany.getCompanyID()) %>" onClick="check1()"></td>
                    <td bgcolor="#FFB76F"><div align="center"><span class="style38"><a href="EditCompany.jsp?id=<%=(aCompany.getCompanyID()) %>"><%=(aCompany.getCompanyName())%> </a></span></div></td>
                    <td bgcolor="#FFB76F"><div align="center"><span class="style38"><%=(aCompany.getEmail()) %></span></div></td>
                    <td bgcolor="#FFB76F"><div align="center"><span class="style38"><%=(aCompany.getPhone())%></span></div></td>
                  </tr>
                  <%} %>
                   </table>
                <%}
               ...
               <%} %> 
                      <div align="center">
                        <input type="button" name="button" id="button" value="Add" onClick="javascript:location.href='NewCompany.jsp'">
                      <% if(!cCoreHash.isEmpty())
         				{%>
