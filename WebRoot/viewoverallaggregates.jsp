        ...
        <tr>
          ...
          <td width="743" height="391" align="center" valign="top" background="index_files/BG.gif" bgcolor="#ff9900" style="width: 190px;"><div align="center">
            ...
            <tr>
              ...
              <form name="acadamicreg" action="OverallAggregateAction.jsp" >
               <input type="hidden" name="loginname" value="<%=(String)session.getAttribute("user")%>"/>        <%
               try
               {
        			String username=(String)session.getAttribute("user");
            		CoreHash tCoreHash = new AggregatesDAO().getOverallAggregates();
        ...
        %>
                <table width="528" border="0" align="center" bordercolor="#CD817E" bgcolor="#FFDBA6">
                  ...
                  <tr>
					...
					int i=1;
					int aggregate = 0;
					     if(tCoreHash.get(username)!=null)
					     {	   aggregate = ((Integer)tCoreHash.get(username)).intValue();  
					%>
                      ...
                      <tr>
                        ...
                        <td width="155"><label>
                          ...
                          <input type="text" name="aggregate"  id="textfield2" value="<%=aggregate%>"/>
                        </label></td>
                      </tr>
                      <%}
					  else
					  {%>
                        ...
                        <input type="hidden" name="flag" value="0"/>
                          <input type="text" name="aggregate" id="textfield2" />
                        </label></td>
                      </tr>
