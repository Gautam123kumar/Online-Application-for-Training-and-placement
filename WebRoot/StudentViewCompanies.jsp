          	...
          	{%>
                <table width="86%" border="0" align="center">
                  ...
                  <%
                    ...
                    %>
                  <tr>
                    <td bgcolor="#FFB76F"><div align="center"><span class="style38"><a href="ViewCompany.jsp?id=<%=(aCompany.getCompanyID()) %>" target="_blank"><%=(aCompany.getCompanyName())%> </a></span></div></td>
