               ...
               %>
                <table width="328" border="0" align="center">
                  <tr>
                    ...
                    <td width="204"><label>
                      <input name="tname" type="text" id="tname" size="30" value="<%=aTraining.getTrainingName() %>">
                    </label></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><label>
                      <input name="ttime" type="text" id="ttime" size="30" value="<%=aTraining.getTrainingtime() %>">
                    </label></td>
                  </tr>
                  <tr>
                    <td><span class="style40">Description</span></td>
                    <td><label>
                      <textarea name="tdesc" id="tdesc" cols="28" rows="5"><%=aTraining.getDescription() %></textarea>
                    </label></td>
                  </tr>
                  <tr>
