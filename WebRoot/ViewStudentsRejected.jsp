      ...
      <table bgcolor="#ff9900" border="0" cellpadding="0" cellspacing="0" width="778">
        ...
        <tr>
          ...
          <td width="751" height="391" align="center" valign="top" background="index_files/BG.gif" bgcolor="#ff9900" style="width: 190px;"><div align="center">
              ...
              <td width="737" height="42"><div align="center" class="style25">
                <form name="form1" method="post" action="">
                  <label>
                    ...
                    <select name="notiid" id="id" onChange="javascript:location.href='ViewStudentsRejected.jsp?notiid='+document.form1.notiid.value">                        
                        <%
            ...
            <tr>
              <td height="232" valign="top"><form name="f" method="post" action="UpdateStatus.jsp">
             ...
             if(!cCoreHash.isEmpty())
          	{
          	    report += "<table width='60%' border='0' align='center'><tr>"+
                    ...
                    "</tr>";
          	%>
                    <span class="style36"> <center>Rejected Students</center> <div align="Right">    <strong> Export to:</strong> <a href="ExportXLS"><strong>XLS</strong> </a></div></span>
                        <table width="66%" border="0" align="center">
                  <tr>
                    <td width="65" bgcolor="#FF9600"><div align="center"><strong>Roll No</strong></div></td>
                    <td width="102" bgcolor="#FF9600"><div align="center"><strong>Student Name</strong></div></td>
                    <td width="82" bgcolor="#FF9600"><div align="center"><strong>Course</strong></div></td>
                    <td width="93" bgcolor="#FF9600"><div align="center"><strong>Discipline</strong></div></td>
                    <td width="122" bgcolor="#FF9600"><div align="center"><strong>Semister</strong></div></td>
                    </tr>
                  <%
                    Enumeration enu = cCoreHash.elements();
                    ...
                    while(enu.hasMoreElements())
                    {
                        ...
                        if(aNotification.getStatus().equals("Rejected") && aNotification.getNotificationID()==Integer.parseInt(request.getParameter("notiid")))
                        {
                           ...
                           report+="<tr><td bgcolor='#FFB76F'><span class='style40'><strong>"+(aNotification.getRollNo())+"</strong></span></td>"+
