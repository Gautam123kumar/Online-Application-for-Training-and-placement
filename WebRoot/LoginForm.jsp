...
<body  leftmargin="0" rightmargin="0" topmargin="0" bottommargin="0"  bgcolor="silver"><center>
<table style="width: 778px;" background="" border="0" cellpadding="0" cellspacing="0" width="70">
  <tbody>
        ...
        <tr>
          ...
          <td width="751" height="391" align="center" valign="top" background="index_files/BG.gif" bgcolor="#ff9900" style="width: 190px;"><div align="center">
            ...
            <tr>
              ...
              <form name="login" action="LoginAction.jsp" onSubmit="return validate()" method="post">
              <table width="314" height="178" border="0" align="center" bordercolor="#FF9900" bgcolor="#FFDBA6">
                  <tr>
                    <td width="287" height="29" bgcolor="#FF9900"><div align="center" class="style11">L o g i n</div></td>
                    </tr>
                  <tr>
                    <td height="120"><table width="226" border="0" align="center">
                        <tr>
                          <td width="79"><span class="style36">Username</span></td>
                          <td width="189"><input type="text" name="username">                          </td>
                        </tr>
                        <tr>
                  ...
                  <tr>
                    <td height="21" valign="baseline"><div align="center"><span class="style26"><span class="style31"><a href="RecoverPassword.jsp">Forgot Password ! !......</a></span></span> <br>
                            <img src="images/regisbot.gif" alt="a" width="280" height="3"></div></td>
                    </tr>
              </table>
              </form>
              <p align="center"><a href="RegisterForm.jsp"><img src="images/registernow.gif" width="93" height="82" border="0"></a>&nbsp;</p></td>
            </tr>
