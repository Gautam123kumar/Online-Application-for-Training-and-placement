      ...
      <table bgcolor="#ff9900" border="0" cellpadding="0" cellspacing="0" width="757">
            ...
            <tr>
              ...
              <form name="acadamicreg" action="AggregateAction.jsp" >
               ...
               try
               {
            		...
            		CoreHash tCoreHash = new AggregatesDAO().getAggregates(username);
        ...
        %>
                <table width="528" border="0" align="center" bordercolor="#CD817E" bgcolor="#FFDBA6">
                  ...
                  <tr>
                    <td width="522" valign="top"><table width="545" border="0" align="center" bgcolor="#FFDBA6">
                    <%
					...
					%>
                      <tr>
                       <td width="20"><label>
                        ...
                        <td width="143"><span class="style36 style38">Semister <%=(aAggregates.getSemister())%></span></td>
                        <td width="144" ></td>
                        <td width="85">&nbsp;</td>
                        <td width="155"></td>
                      </tr>
					  ...
					  {%>
                          <tr>
                        <td width="20"><label>
                          <input type="checkbox" name="sem<%=i%>" id="checkbox7">
                        </label></td>
                        <td width="146"><span class="style36 style38">Semister <%=i%></span></td>
                        <td width="144" ></td>
                        <td width="75">&nbsp;</td>
                        <td width="175"></td>
                      </tr>
                      ...
                      <tr>
                        <td colspan="4" valign="top"><strong><a href="viewoverallaggregates.jsp">Over All Aggregate</a></strong></td>
                      </tr>
                    </table></td></tr>
                      <%}
					%>
