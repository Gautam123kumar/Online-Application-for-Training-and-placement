      ...
      <table bgcolor="#ff9900" border="0" cellpadding="0" cellspacing="0" width="778">
        ...
        <tr>
          ...
          <td width="751" height="391" align="center" valign="top" background="index_files/BG.gif" bgcolor="#ff9900" style="width: 190px;"><div align="center">
            ...
            <tr>
              <td width="737" height="42"><div align="center" class="style36 style39"><strong>Assigned Notifications</strong></div></td>
            </tr>
            <tr>
	     ...
	     try{
             ...
             cCoreHash = aNotificationdao.getNotifications((String)session.getAttribute("user")); 
          	...
          	{%>
                <table width="86%" border="0" align="center">
                  ...
                  <%
                    ...
                    %>
                  <tr>
                    <td bgcolor="#FFB76F"><div align="center"><span class="style38"><a target="_blank" href="StudentViewNotification.jsp?id=<%=(notification.getNotificationID()) %>"><%=(notification.getNotificationID())%> </a></span></div></td>
                    <td bgcolor="#FFB76F"><div align="center"><span class="style38"><a target="_blank" href="StudentViewNotification.jsp?id=<%=(notification.getCompanyID()) %>"><%=(((Company)(aCoreHash.get(new Integer((notification.getCompanyID())))))).getCompanyName() %> </a></span></div></td>
