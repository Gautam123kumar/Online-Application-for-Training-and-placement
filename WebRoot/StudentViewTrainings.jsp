          	...
          	{%>
                <table width="86%" border="0" align="center">
                  ...
                  <%
                    ...
                    %>
                  <tr>
                    <td bgcolor="#FFB76F"><div align="center"><span class="style38"><a href="ViewTraining.jsp?id=<%=(training.getTrainingid()) %>" target="_blank"><%=(training.getTrainingName()) %> </a></span></div></td>
